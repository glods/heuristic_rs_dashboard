...
def gompertz_eval_rain_with_s1():
    ...
    st.write('______________________________________________________________________________________________')
    st.subheader('EVALUATION OF GOMPERTZ METHOD IN 2022  - SENINEL 1')

    st.write('----------------------------')

    dataCOM = pd.read_csv('/home/glorie/Documents/DASHBOARD/compararison/data_prediction.csv')
    dataCOM = dataCOM[dataCOM['year'] == 2022]
    latext = r'''
        #### HOW IT WORKS
        With all images $n$ available at time $t$, predict the total area that will be flooded during the  season 
    ...
    # ----------------------  ALL DATA
    data = pd.read_csv('/home/glorie/Documents/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/grid52_SENT1/prediction_growth_ts.csv')
    gcol = data.columns
    gcol = gcol[1:]
    data = data[gcol]
    data['class'] = 'GOMPERTZ'
    # HIS
    data_hist22 = pd.read_csv('/home/glorie/Documents/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/grid52_SENT1/hist/prediction_growth_ts.csv')
    ...
    path = '/home/glorie/Documents/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/grid52_SENT1/df/'
    ...
    path = '/home/glorie/Documents/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/grid52_SENT1/hist/df/'
    dfpath = os.listdir(path)
    sum_ = []
    dfs = pd.DataFrame()
    cp = 0
