...
def harvest():
    ...
    i='2019'
    DATA_URL =  'data/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/GRID2917/Dagana/RAINY_SEASON/'+i+'/harvest/harvest_Dagana'+i+'.csv'
    ...
    if 'GRID-LEVEL ANALYSIS' in vizuals:
        ...
        datagridlevel = 'data/harvest/dag_grid2917rainy.csv'
