...
def gompertz_eval_dhs_2022():
    ...
    # dataCOM = pd.read_csv('data/DATA_TO_SHARE/GRID52/flooding/DHS/flooded_area_dagana_2022.csv')
    ...
    # df_['class'] ='RS'
    # dataCOM = df_
    dataCOM = pd.read_csv('data/comparison/data_prediction_dhs.csv')
    ...
    # ----------------------  ALL DATA
    data = pd.read_csv('data/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/DHS/grid52v2/prediction_growth_ts.csv')
    gcol = data.columns
    gcol = gcol[1:]
    data = data[gcol]
    data['class'] = 'GOMPERTZ'
    # HIS
    data_hist22 = pd.read_csv('data/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/DHS/grid52v2/hist/prediction_growth_ts.csv')
    ...
    path = 'data/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/DHS/grid52v2/df/'
    ...
    path = 'data/DATA_TO_SHARE/GRID2917-20220922T122839Z-001/output_model/grid52/DHS/grid52v2/hist/df/'
    dfpath = os.listdir(path)
    sum_ = []
    dfs = pd.DataFrame()
    cp = 0
