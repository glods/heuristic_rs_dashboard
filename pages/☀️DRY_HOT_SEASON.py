...
if st.checkbox('HARVEST ESTIMATES '):
    ...
    st.sidebar.header("FLOODING ESTIMATES")
    ...
    # datau_ = pd.read_csv('/home/glorie/Documents/DASHBOARD/compararison/data_prediction_dhs.csv')
    ...
    if 'Summary statistics' in vizuals:
        ...
        # st.write('______________________________________________________________________________________________')
        st.subheader('-------------------- MAPS of flooding events ----------------------')
        im_path = 'data/flooding_maps/flooding/style2/'
        fig_col1map, fig_col2map = st.columns(2)
        with fig_col1map:
            image = Image.open(im_path + 'map2019.png')
            # displaying the image on streamlit app
            st.image(image)
            # st.image(image, caption='Enter any caption here')

            # -------------------------------------------------
            image = Image.open(im_path + 'map2021.png')
            # displaying the image on streamlit app
            st.image(image)

        with fig_col2map:
            image = Image.open(im_path + 'map2020.png')
            # displaying the image on streamlit app
            st.image(image)

            # ---------------------------------------------------
            image = Image.open(im_path + 'map2022.png')
            # displaying the image on streamlit app
            st.image(image)
        ...
        with fig_col1:
        # --------------------------------------------------
            datau = pd.read_csv('data/comparison/data_prediction_dhs.csv')
            period ='DHS'
    ...
    if 'COMPARISON' in vizuals:
        ...
        data = pd.read_csv('data/comparison/data_prediction_dhs.csv')
        period ='DHS'
